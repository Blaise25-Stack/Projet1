    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-6 sm:p-8">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Académie de la Genèse</h1>
          <p className="text-gray-600 mt-2 text-sm sm:text-base">Check-School Application web de gestion scolaire</p>
        </div>
